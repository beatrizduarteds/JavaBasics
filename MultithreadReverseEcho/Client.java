...
class Client{
	...
	public static void main(String args[]) throws Exception //handle IO exception
  {
		...
		// create a socket client object to connect to the serve by it's IP address and port number
		Socket skt=new Socket("localhost", 2500); // 10.91.90.93 or localhost or 127.0.0.1
